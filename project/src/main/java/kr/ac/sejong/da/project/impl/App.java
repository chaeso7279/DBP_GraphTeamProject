...
public class App {
	public static void main(String[] args) throws SQLException {
		...
		v.setStatement(dbMgr.getInstance().getStatement());
		  ...
		  Graph g = new JGraph(); Vertex v1 = g.addVertex("1"); 
		  Vertex v2 = g.addVertex("2"); Vertex v3 = g.addVertex("3");
		  
		  Edge e1 = g.addEdge(v2, v1, "label"); Edge e2 = g.addEdge(v2, v3, "label");
		  
		  Iterator<Edge> ei1 = v2.getEdges(Direction.OUT, "label").iterator(); 
		  //결과는 v1, v3를 포함한 iterator 
		  while(ei1.hasNext())
		  { Edge e =ei1.next();
